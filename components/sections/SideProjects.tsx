...
export default function SideProjects() {
  ...
  return (
    <div className="mt-10 space-y-9">
      <h3 className="text-[15px] font-medium text-text tracking-[-0.01em]">Side Projects</h3>
      ...
      <div className="space-y-7">
        {sideProjects.map((item, index) => (
          <div key={index} className="grid grid-cols-1 md:grid-cols-[120px_1fr] gap-1 md:gap-4">
            ...
            <a
              href={item.href}
              className="group inline-flex items-center gap-1.5 text-base font-medium text-text leading-[1.4] hover:opacity-70 transition-opacity duration-150"
            >
              {item.title}
